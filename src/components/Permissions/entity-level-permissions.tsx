...
const EntityLevelPermission: React.FC<props> = (props) => {
  ...
  useEffect(() => {
    ...
    // props.savePermissions(savePermissions);
  }, [props.savePermissions]);
  ...
  return <Table data={tableData} columns={columnData} />;
};
export default EntityLevelPermission;
